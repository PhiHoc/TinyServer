...
//		return PageGeneratorManager.getAddressePage(driver);
//	}
//
//	public UserMyProductReviewPO openMyProfuctReviewPage(WebDriver driver) {
//		waitForElementClickable(driver, NopCommerceBasePageUI.MY_PRODUCT_REVIEW_LINK);
//		clickToElement(driver, NopCommerceBasePageUI.MY_PRODUCT_REVIEW_LINK);
//		return PageGeneratorManager.getMyProductReviewPage(driver);
//	}
//
//	public UserCustomerInforPO openCustomerInforPage(WebDriver driver) {
//		waitForElementClickable(driver, NopCommerceBasePageUI.CUSTOMER_INFOR_LINK);
//		clickToElement(driver, NopCommerceBasePageUI.CUSTOMER_INFOR_LINK);
...
//		waitForElementVisible(driver, NopCommerceBasePageUI.DYNAMIC_TEXT_BOX_BY_ID, textboxID);
//		senkeysToElement(driver, NopCommerceBasePageUI.DYNAMIC_TEXT_BOX_BY_ID, value, textboxID);
//	}
//
//	public void clickToButtonByValue(WebDriver driver, String buttonValue) {
//		waitForElementClickable(driver, NopCommerceBasePageUI.DYNAMIC_BUTTON_BY_CLASS, buttonValue);
//		clickToElement(driver, NopCommerceBasePageUI.DYNAMIC_BUTTON_BY_CLASS, buttonValue);
//	}
//
//	public void selectDropDownByName(WebDriver driver, String dropdownName, String itemValue) {
//		waitForElementVisible(driver, NopCommerceBasePageUI.DYNAMIC_DROPDOWN_BY_NAME, dropdownName);
//		selectDropdownByText(driver, NopCommerceBasePageUI.DYNAMIC_DROPDOWN_BY_NAME, itemValue, dropdownName);
//	}
//
//	public String getErrorMessageAtMandantoryDileByName(WebDriver driver, String fieldID) {
//		waitForElementVisible(driver, NopCommerceBasePageUI.DYNAMIC_ERROR_MESSAGE_BY_ID, fieldID);
//		return getElementText(driver, NopCommerceBasePageUI.DYNAMIC_ERROR_MESSAGE_BY_ID, fieldID);
//	}
//
...
//		waitForElementInvisible(driver, NopCommerceBasePageUI.LOADING_ICON);
//	}
//
//	public void waitAjaxLoadingVisible(WebDriver driver) {
//		waitForElementVisible(driver, NopCommerceBasePageUI.LOADING_ICON);
//	}
...
//
//		getElement(driver, getDynamicLocator(NopCommerceBasePageUI.UPLOAD_FILE_TYPE_PANEL, panelID))
...
//		fullFileName = fullFileName.trim();
//
//		getElement(driver, getDynamicLocator(NopCommerceBasePageUI.UPLOAD_FILE_TYPE)).sendKeys(fullFileName);
//	}
